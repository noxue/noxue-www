        ...
        <div class="container">
            <div class="kcap-1 table-responsive" style="width:100%;">
                <table class="table table-bordered">
                    ...
                    <tr class="warning">
                        <th>bootstrap</th><td>全世界最流行的前端框架之一，让非专业的前端也能做出酷炫的网页。您现在正在看的页面也用到了这个框架。</td>
                    </tr>
                    <tr class="success">
                        <th>php</th><td>让网站具备灵魂，处理业务逻辑，不只是徒有其表。我们假设您是零基础，着重讲解语法和php高级特性，为后面课程打下坚实的基础。</td>
                    </tr>
                    <tr class="info">
                        <th>正则表达式</th><td>字符串处理必备利器，采集程序，爬虫必备技术</td>
                    </tr>
                    <tr class="success">
                        <th>mysql数据库</th><td>数据是每个网站的核心部分，这里我们将详细讲解数据库的各种知识点。</td>
                    </tr>
                    <tr class="info">
                        <th>redis</th><td>Key-Value数据库，讲解如何利用redis缓存数据提高并发量，解决性能问题。</td>
                    </tr>
                    <tr class="warning">
                        <th>laravel框架</th><td>前段有框架，后端自然也有，这是我们本次课程最难的部分，世界上最流行的php框架。学会之后可以快速的开发出您想开发的任何网站。</td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="container">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <p>1.<b>学员的经济承受能力。</b>我问过一些从机构刚培训出来的学员，“你觉得这个培训值多少钱？你能承受多少钱的培训费用？”  “8000差不多”，所以8000是一个对大多数学员完全没有压力的价格。</p>
        ...
        <div class="slide">
            <div class="container">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <p>了解薪水很简单，it行业中比较专业的招聘网站上面搜一下php就知道了，比如拉钩网【<a href="https://www.lagou.com/jobs/list_php?px=default&gj=3%E5%B9%B4%E5%8F%8A%E4%BB%A5%E4%B8%8B&city=%E6%9D%AD%E5%B7%9E#filterBox" target="_blank">点击查看杭州PHP 1-3年经验薪资水平</a>】，工资范围在<b>8000元-200000元</b>之间，其他城市可以自己查看。换句话说，参加培训的费用，只是您出来后一个月的工资。</p>
            ...
            <div class="container">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <p>很多机构是什么人都收，不结合学员自身情况考虑，用一些销售技巧让学员报名，不管学了能不能找到工作，甚至有的学员根本不喜欢这个行业。其实是很不负责的做法。</p>
                        <p>注：我们并非觉得高中学历以下的朋友不适合编程，有的行业靠逻辑能力，有的行业靠情商或艺术天赋，每个人都有自己的优势，适合自己的才是最好的。</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <p>学习编程至今已7年。</p>
                        <p>格言：技术越分享越多。</p>
                        <p>经历简介：大学毕业就开始工作，虽然换过很多工作，但是都是在做编程工作，从php程序员到php项目主管，期间自学java，后来转java项目主管。</p>
            ...
            <div class="container">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row bgs">
                            <a href="{{asset('images/php/bgs1.jpg')}}"><img class="col-md-4 col-lg-4 col-xs-4 col-sm-4" src="{{asset('images/php/bgs1.jpg')}}" /></a>
                            <a href="{{asset('images/php/bgs2.jpg')}}"><img class="col-md-4 col-lg-4 col-xs-4 col-sm-4"  src="{{asset('images/php/bgs2.jpg')}}" /></a>
                            <a href="{{asset('images/php/bgs3.jpg')}}"><img  class="col-md-4 col-lg-4 col-xs-4 col-sm-4" src="{{asset('images/php/bgs3.jpg')}}" /></a>
                        </div>
                    </div>
                </div>
            </div>
